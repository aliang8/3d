...
def parse_file( fname, edges, transform, screen, color ):
    ...
    while c < len(lines):
        ...
        if line == 'circle':
            ...
            add_edge(edges, x + 1, y, z, x + 1, y, z)
            add_edge(edges, x, y - height, z, x, y - height, z)
            add_edge(edges, x + 1, y - height, z, x + 1, y - height, z)
            add_edge(edges, x, y, z - depth, x, y, z - depth)
            add_edge(edges, x + 1, y, z - depth, x + 1, y, z - depth)
            add_edge(edges, x + width, y, z, x + width, y, z)
            add_edge(edges, x + width + 1, y, z, x + width + 1, y, z)
            add_edge(edges, x + width, y - height, z, x + width, y - height, z)
            add_edge(edges, x + width + 1, y - height, z, x + width + 1, y - height, z)
            add_edge(edges, x + width, y - height, z - depth, x + width, y - height, z - depth)
            add_edge(edges, x + width + 1, y - height, z - depth, x + width + 1, y - height, z - depth)
            add_edge(edges, x + width, y, z - depth, x + width, y, z - depth)
            add_edge(edges, x + width + 1, y, z - depth, x + width + 1, y, z - depth)
            add_edge(edges, x, y - height, z - depth, x, y - height, z - depth)
            add_edge(edges, x + 1, y - height, z - depth, x + 1, y - height, z - depth)
